          ...
          <Grid container spacing={2}>
            <Grid item sm={12} md={8} lg={10}>
              ...
              <Typography variant="subtitle1">
                ...
                <StyledRouterLink to="/about">About</StyledRouterLink> page.
              </Typography>
              <Typography variant="subtitle1">
                For professional information, check the{" "}
                <StyledRouterLink to="/resume">Resume</StyledRouterLink> page.
              </Typography>
              <Typography variant="subtitle1">
                To get in touch, check the{" "}
                <StyledRouterLink to="/contact">Contact</StyledRouterLink> page.
              </Typography>
            </Grid>
